    ...
    .. note::
        ...
        a default value:
            ...
            * variables for dynamic deliveries:
                ...
                * **typeMotion** : the type of motion applied to the patient: 'motionNoisyCos','motionCos','motionBreathHiccup', 'motionBreathCough' or 'motionRecorded'. See package motion for more information. \
                Default: 'motionCos'.
                * **fileRecordedMotion** : if the type motion is 'motionRecorded' this should be the filename ('NAMEFILE.txt') of the motion information. See the module motionRecorded for more information.
