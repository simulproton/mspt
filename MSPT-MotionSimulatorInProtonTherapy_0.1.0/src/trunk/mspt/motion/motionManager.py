...
motionTypes = ['motionNoisyCos','motionCos','motionBreathHiccup','motionBreathCough']
...
class Motion(object):
    ...
    .. note::
        ...
        The new class must implement 'getDisplacementVectorAtTime(timer)' to define the displacement vector at time = timer. On could \
